...
screen main_menu():
    ...
    vbox:
        ...
        imagebutton:
            idle "gui/Jugar_idle.png"
            hover "gui/Jugar_hover.png"
            action Start()

        imagebutton:
            idle "gui/Cargar_idle.png"
            hover "gui/Cargar_hover.png"
        ...
        imagebutton:
            ...
            hover "gui/Acercade_hover.png"
            action ShowMenu("about")

        imagebutton:
            idle "gui/Ayuda_idle.png"
            hover "gui/Ayuda_hover.png"
            action ShowMenu("help")

        imagebutton:
            idle "gui/Salir_idle.png"
            hover "gui/Salir_hover.png"
            action Quit()
